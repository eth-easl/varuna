...
CODEDIR=${23:-"/home/fot/DeepLearningExamples/PyTorch/LanguageModeling/BERT"}
...
CMD="python3 -m torch.distributed.launch --nproc_per_node=$num_gpus --master_addr=$MASTER_ADDR --master_port=$MASTER_PORT --node_rank=$NODE_RANK --nnodes=$NNODES $CMD"
