...
def main():
    ...
    if args.do_train:
        ...
        while True:
            ...
            shared_file_list = {}
            print(f"num files is: {num_files}, f_start_id is: {f_start_id}")
            ...
            print(f"data parallel size is: {data_parallel_size}")
            ...
            for f_id in range(f_start_id + 1 , len(files)):
                ...
                print(f"fid is: {f_id}, data file is: {data_file}, len of train_iter is: {len(train_iter)}")

                
                print(f"Current f_id is {f_id}, number of iterations is: {len(train_iter)}")
                for step, batch in enumerate(train_iter):

                    print(f"--------- Now at epoch {epoch}, global step {global_step}, step {step}")
                    training_steps += 1
