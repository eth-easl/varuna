...
if __name__ == "__main__":
   ...
   # current_env["PATH"] = "PATH=\"/home/varuna/anaconda3/bin:$PATH\""
    ...
    for i,machine in enumerate(reachable_machines):
        ...
        setup_cmd = "python3 /home/fot/varuna/varuna/check_fuse.py && sudo rm -rf /home/fot/varuna && git clone https://github.com/eth-easl/varuna.git /home/fot/varuna && cd /home/fot/varuna && git fetch origin baseline && git pull origin baseline && git checkout baseline &&  sudo python3 setup.py install "
        fuse_cmd = "python3 /home/fot/varuna/varuna/check_fuse.py "
